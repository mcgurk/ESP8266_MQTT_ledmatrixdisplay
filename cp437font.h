...
const byte cp437_font [][8] PROGMEM = {
  ...
  //{0xcc,0xd2,0x10,0x10,0x10,0x12,0x0c,0x00}, //0xF0/240 (combined degree symbol and C)
  //{0x03,0x03,0x00,0x3e,0x7f,0x63,0x36,0x00}, //0xF0/240 (combined degree symbol and C)
  //{0x03,0x03,0x00,0x3e,0x7f,0x63,0x22,0x00}, //0xF0/240 (combined degree symbol and C)
  {0x03,0x03,0x00,0x3e,0x7f,0x63,0x63,0x00}, //0xF0/240 (combined degree symbol and C)
